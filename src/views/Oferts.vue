      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-form-label">
            ...
            <base-button class="btn-1" outline rounded >first tag</base-button>
            <div class="mb-3 mt-5">
              <small class="text-uppercase">CATEGORIES</small>
            </div>
            <base-button class="btn-1" outline rounded >First category</base-button>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  created () {
    this.ofertID = this.$route.query.id
    /*this.renderOfert()*/
  }
